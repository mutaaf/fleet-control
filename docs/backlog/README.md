...
| 0056 | Time saved this month - each project card surfaces ~Nh saved from cross-fleet lessons so the moat becomes visible on the home grid | P1 | in-progress | observability |
